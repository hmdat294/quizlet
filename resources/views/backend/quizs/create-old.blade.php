                    ...
                    <div class="card-body p-5">
                        <div>
                            ...
                            <div id="questions-container">
                                ...
                                <div>
                                    <div id="questions-container">
                                        <div class="mb-6 question-container-essay question-c mt-3"
                                            data-question-counter="0" style="display: none;">
                                            ...
                                            <div class="mt-2 d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <button type="button" class="btn btn-primary px-4 add-blank">Thêm chỗ
                                                        trống</button>
                                                    <button type="button" class="btn btn-danger px-4 delete-blank">Xóa
                                                        chỗ
                                                        trống</button>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12 d-flex gap-3 my-4">
                            ...
                            <button type="button" id="add-essay" class="btn btn-primary px-4"
                                style="display: none;">Thêm Quiz điền vào chỗ
                                trống</button>
