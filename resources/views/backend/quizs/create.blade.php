            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <div id="questions-container">
                        <div class="mb-6 question-container mt-3" data-question-counter="0">
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control rounded" id="question" name="questions[0][question]" placeholder="Enter Name" required>
                    ...
                    <div class="col-4">
                        ...
                        <select name="questions[0][correct_answer]" class="form-select p-2 border rounded" id="answer" name="answer" required>
