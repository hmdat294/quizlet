...
@section('content')
    <section
        ...
        style="background-image: url({{ asset('frontend/img/page-header/page-header-background-transparent.jpg') }});">
        <div class="container">
            <div class="row mt-5">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-10 text-center">
                        <h2 class="font-weight-bold mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
                            data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1500"
                            style="animation-delay: 1500ms;">About Us</h2>
                        <p class="text-color-dark pb-3 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
                            ...
                            style="animation-delay: 1700ms;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Suspendisse in arcu facilisis quam aliquam ultrices quis in purus. Donec volutpat et justo et
                            viverra. Suspendisse id justo a ipsum viverra ultrices quis et quam. Pellentesque id finibus
                            elit, vitae finibus est. Sed mollis orci eget ex euismod vulputate. Praesent fermentum dignissim
                            congue. Praesent sapien mi.</p>
                        <a href="{{ route('about_us') }}"
                            ...
                            data-plugin-options="{'accY': 100}" style="animation-delay: 1900ms;">READ MORE</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row">
                <div class="col">
                    <div class="blog-posts text-center">
                        ...
                        <h2 class="font-weight-bold mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
                            data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1500"
                            style="animation-delay: 1500ms;">Coding Skill Tests</h2>
                        ...
                        <div class="row">
                            ...
                            @foreach ($quizs as $quiz)
                                <div class="col-md-4 col-lg-4 mb-3 appear-animation animated fadeInUpShorter appear-animation-visible"
                                    ...
                                    <div class="card card-background-image-hover border-0"
                                        ...
                                        <div class="card-body text-center p-5">
                                            ...
                                            <h4 class="card-title mt-2 mb-2 text-5 font-weight-bold">{{ $quiz->title }}
                                            </h4>
                                            <p class="card-text">{{ $quiz->description }}</p>
                                            <a href="{{ route('quiz.view', $quiz->id) }}"
                                                class="btn btn-primary btn-modern">View quiz</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
