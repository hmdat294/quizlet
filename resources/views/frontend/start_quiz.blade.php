                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="">
                        <div class="badge badge-warning badge-md">
                            <h1 class='timer m-0 font-weight-bold' style="display: inline-flex;" data-minutes-left={{ $quiz->duration }}></h1>
                        </div>
                        ...
                        <div class="card border-radius-0 bg-color-light border-0 text-left">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mx-5 d-inline">
                                    ...
                                    $outputString = preg_replace_callback('/\[blank_(\d+)\]/', function ($matches) {
                                    return '<input class="border-bottom border-0 border-2" type="text" name="question[]blank_' . $matches[1] . '">';
                                    }, $q['question']);
