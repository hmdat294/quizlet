                        ...
                        @foreach ($allQuestions as $q)
                            <div class="mb-3 appear-animation animated bounceInRight appear-animation-visible q-{{ $i }}"
                                    ...
                                    @if ($q['q_type'] == 'question')
                                        <div class="card-body">
                                            ...
                                            <ul class="list list-primary list-borders mcq-list text-4 text-dark">
                                                <li class="d-flex">
                                                    <label>
                                                        <input type="radio" name="options[{{ $q['id'] }}]"
                                                            value="1">
                                                        {{ $q['option_1'] }}
                                                    </label>
                                                </li>
                                ...
                                <div class="form-group mt-3">
                                    <button type="button" class="btn btn-modern btn-rounded btn-tertiary mb-2 back"><i
                                            class="icon-arrow-left icons"></i><i
                                            class="icon-arrow-left icons mr-2"></i>Back</button>
